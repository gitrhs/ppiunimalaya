                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 text-center">
                            <div class="youtube-background">
                                <iframe width=96% style="aspect-ratio: 16/9; margin-top: 15px; border-radius: 10px;" src="https://www.youtube.com/embed/-8AkpaFBYJM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                <div style="width=96%;">
                                    <div class="row">
                                        <div class="col-3">
                                            1

...
<html lang="id">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="section1">
                <div class="d-block d-lg-none text-center">
                    <img src="https://ppiunimalaya.id/wp-content/uploads/2020/05/LOGOPPIUM-1.png" width=60% height=auto>
                </div>
                <div class="row">
                    <div class="col-12 col-lg-6 d-flex align-items-center justify-content-center">
                        <div class="text-center">
                            <p class="title"><b>PPI UNIVERSITI MALAYA</b></p>
        ...
        <div style="background-color: white; margin-top: -5px; color: #101f32; margin-bottom: -5px;">
            <!-- Wave -->
                ...
                <div class="text-center">
                    ...
                    <div class="d-flex flex-wrap justify-content-center">
                      <div class="p-2">
                        ...
                        <label class="btn btn-outline-dark btn-sosmed btn-filter rounded-pill" for="instagram">
                          Instagram
                        </label>
                      </div>
                      <div class="p-2">
                ...
                <div id="facebook-div">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6 text-center">
                            <div class="fb-page" data-href="https://www.facebook.com/ppiunimalaya" data-tabs="timeline" data-width=380 data-height="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/ppiunimalaya" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/ppiunimalaya">PPI Universiti Malaya</a></blockquote></div>
                        </div>
                        <div class="col-12 col-lg-5 d-flex flex-column align-items-center justify-content-center">
                            <h1 style="text-align: center;">
        ...
        <div class="transition-footer-div"></div>
        <!-- JS -->
